...
<summary>Task 1. Create a project for Lab 6 (expand for instructions)</summary>
...
<summary>Task 1. Create a project for Lab 6</summary>
...
Run through **STEP 1** of the tutorial here <https://psu-spatial.github.io/Geog364-2025/Tutorial_LISA.html>
You should stop when you made maps of the city. e.g. don't carry onto step 2.
...
Get the code working and making the plots.  For each step, in your own words explain what you are doing for each piece of code and why you chose your city.
...
Now make some LISA plots for your city.  We will discuss what these mean during Wednesdays class. Based on that, see if you can interpret the results for your city, including

a) Whether your results correspond to reality. Remember you can change your background map to identify where places are and do some googling! For example 
...
b) The significance of your results e.g. where is highly significant and where is not?
