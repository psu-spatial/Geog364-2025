...
city, lets us a local UTM projection, 26916. To find one for your area,
see
...
FOR THIS CODE CHUNK, set results=FALSE as a codechunk option, or it will
swamp your knit: <br> `{r, results=FALSE}`
