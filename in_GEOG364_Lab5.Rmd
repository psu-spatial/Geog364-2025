...
Explain what the US-Census American Community survey is and why it's a useful dataset.  Explain what the object of analysis is and its boundaries in time (e.g. does one survey represent all of US history?)
...
WE WILL COVER THIS ON WEDNESDAY Explain the modifiable areal map problem and both the shape and zone
    effects. Write any impacts of MAUP do  you see in your analyses and why. 
...
Look at the best practice for chloropleths <https://blog.datawrapper.de/choroplethmaps/> and make a new version
