...
Congratulations! If you have made it here you already have a B.  I WILL GRADE PROGRESSIVELY DEPENDING ON HOW FAR THROUGH YOU GET.  As always, an A grade is reasonable, 100% is hard. 
 


OK, so you have now worked through an entire assessment of Moran's I. In reality, it's much shorter than we just made it.  For a given dataset, we 

 - Read in the data
 - Make it spatial and assign map projection
 - (use st_make_value to remove features that crash the moran code)
 - Calculate neighbours and spatial weights matrix of your choice
 - Calculate the Moran's I scatterplot and hypothesis test.
 
In the question below, I'm asking you to run the whole process for a new scenario. Remember you can copy the code into a single code chunk, like I did at the start of the tutorials.
 
20. Try the full process (15 marks)
...
::: 
 ...
 - For 'broadband access' for counties in Pennsylvania and 1st order queens.
 ...
 - Repeat for West Virginia and compare your results. Comment on any differences you see.
