...
<br>
All the data is on the Lab 5 canvas page.  But here's a shortcut. Click each link below to download the data.  
...
<summary>Task 2. Create a project for Lab 5 (expand for instructions)</summary>
...
<summary>Task 2. Get the data & **put it in your Lab 5 folder**</summary>

<br>

All the data is on the Lab 5 canvas page.  But here's a shortcut. Click each link below to download the data and put it directly into your Lab 5 folder.
...
You are welcome to use/edit the template you made in Lab 5. If you are unsure what I mean by that, follow these instructions.
...
Lets use similar options to Lab 5, although you could try a different theme.  Remember YAML code is annoying to edit, because here, *spaces really do matter*. Everything has to be perfect or it won't knit.
