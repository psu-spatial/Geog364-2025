...
-   Run the same code several times for both the Schools and McDonald’s data, varying sigma from a very small value (e.g. 1 km) to a very large one (e.g. 1000 km). As you change sigma, think about the real-world processes that might be driving the patterns you see. <br>
...
Include the corresponding maps and briefly explain your reasoning below each map.

-   A* bonus question: Explain how the bandwidth issue links with MAUP's scale effect.
