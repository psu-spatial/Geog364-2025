...
5. **Rename the file** <br><br>   "GEOG364_Lab1_AddYourEmailID.Rmd" should now be in your Lab 1 project folder (either on your computer or on posit-cloud).  <br><br>
Go to the Files tab (one of the quadrants) in R-studio. If you are running your Lab 1 you should be able to see it. Click the tick-box next to it and click the Rename button. Change AddYourEmailID to your PSU email ID e.g. mine is hlg5155. 
 
 
6. **Open the file & follow the instructions!".  Come back here at the end.
